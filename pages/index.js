...
function HomePage() {
  ...
  async function onBuyHandler(NFtBuyToken) {
    ...
    const price = ethers.utils.parseUnits(NFtBuyToken.price.toString(), 'ether')   
    const transaction = await contract.buyItem(NFtBuyToken.NFTId, {
      value: price
    })
  ...
  return <NftList loadednfts={nfts} caller={callerName}  onBuyClicked={onBuyHandler} />;
}
